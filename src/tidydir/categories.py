...
CATEGORY_EXTENSIONS: Dict[FileCategory, Set[str]] = {
    ...
    FileCategory.CODE: {
        ...
        '.def', '.exp', '.pdb', '.idb', '.ilk', '.manifest', '.dep',
        '.iobj', '.ipdb', '.pch', '.gch', '.pchi', '.hdmp', '.ncb',
        '.aps', '.sbr', '.bsc', '.fd', '.fe', '.tlog', '.lastbuildstate',
        '.ilk', '.meta', '.obj', '.pch', '.pgc', '.pgd', '.rsp', '.tli',
        '.tlh', '.tmp', '.tmp_proj', '.log', '.vspscc', '.vssscc', '.builds',
        ...
        '.m', '.mm', '.M', '.pch', '.d', '.di', '.dd', '.ddoc', '.def',
        '.map', '.exp', '.lib', '.pc', '.pod', '.rst', '.inc', '.hs',
        ...
        '.ngo', '.asy', '.prj', '.psl', '.rpt', '.veo', '.vho', '.vmo',
        '.syr', '.par', '.pad', '.unroutes', '.xpi', '.xst', '.prj',
        '.stx', '.map', '.ngm', '.mrp', '.xrpt', '.csv', '.pad', '.txt',
        '.drc', '.bgn', '.bit', '.xwbt', '.ngd', '.bld', '.ncd', '.ngr',
        '.pcf', '.auto', '.map', '.mrp', '.ngm', '.trace', '.twr', '.twx',
        '.log', '.cmd_log', '.jhd', '.ant', '.gradle', '.mvn', '.ivy',
